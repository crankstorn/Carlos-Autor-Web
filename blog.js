document.addEventListener('DOMContentLoaded', () => {
  ...
  // Función para formatear el contenido con párrafos y saltos de línea.
  ...
  function displayPosts(posts) {
      ...
      posts.forEach((post, index) => {
        ...
        if (index === 0) {
          ...
          // --- CORRECCIÓN CLAVE ---
          // El enlace "Leer más" DEBE usar la URL limpia.
        ...
        postElement.innerHTML = `
          <h2 class="text-4xl font-serif mb-2 text-center">
            <!-- --- CORRECCIÓN CLAVE --- -->
            <!-- El enlace del título DEBE usar la URL limpia. -->
